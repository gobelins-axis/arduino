...
// --- Joysticks -------------------------------------------------------------
//
// Pots must be powered from 3.3V. Teensy 4.1 pins are not 5V tolerant and a
// 5V-fed pot would also clip at 1023 over most of its travel.
...
// A message is sent when either axis moved at least this many ADC counts
